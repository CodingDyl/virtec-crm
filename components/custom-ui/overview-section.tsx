  ...
  return (
    <>
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-2xl font-bold text-spaceText">Dashboard Overview</h2>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="bg-space2 text-spaceText border-spaceAccent">
          ...
          <CardContent>
            <div className="text-2xl font-bold">R {dashboardData.totalRevenue.toLocaleString()}</div>
        ...
        <Card className="col-span-3 bg-space2 text-spaceText border-spaceAccent">
          <CardHeader>
            ...
            <CardDescription className="text-spaceAlt">
              You have {dashboardData.totalCustomers} total customers.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <ScrollArea className="h-[300px]">
              {dashboardData.recentCustomers.map((customer) => (
                <div key={customer.id} className="mb-4 grid grid-cols-[25px_1fr] items-start pb-4 last:mb-0 last:pb-0">
